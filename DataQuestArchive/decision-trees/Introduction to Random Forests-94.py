...
clf_prediction = clf.predict(test[columns])
clf_auc = roc_auc_score(test["high_income"], clf_prediction)


clf2 = DecisionTreeClassifier(random_state=1, max_depth=5)
clf2.fit(train[columns], train["high_income"])
clf2_prediction = clf2.predict(test[columns])
clf2_auc = roc_auc_score(test["high_income"], clf2_prediction)
...
ensemble_prediction =  numpy.round((predictions+predictions2)/2)

auc = roc_auc_score(test["high_income"],ensemble_prediction)
print(auc)
...
ensemble_prediction = numpy.round(pd.DataFrame(predictions).mean())
print(roc_auc_score(test["high_income"],ensemble_prediction))
