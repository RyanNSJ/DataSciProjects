...
# for col_name in ["education", "marital_status", "occupation",
#                  "relationship", "race", "sex", "native_country",
#                  "high_income"]:
#     col = pandas.Categorical(income[col_name])
...
for col_name in columns:
    information_gain = calc_information_gain(income, col_name, "high_income")
