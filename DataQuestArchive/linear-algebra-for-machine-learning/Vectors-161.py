...
# Add your code here.
plt.quiver(0,0,2,3, color="blue", angles="xy", scale=1, scale_units="xy")
plt.quiver(0,0,-2,-3, color="blue", angles="xy", scale=1, scale_units="xy")
plt.quiver(0,0,1,1, color="gold", angles="xy", scale=1, scale_units="xy")
plt.quiver(0,0,2,2, color="gold", angles="xy", scale=1, scale_units="xy")
